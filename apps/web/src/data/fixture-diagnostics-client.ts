  ...
  checks: [
    {
      ...
      interpretation:
        "This fictional check represents demo mode only; no desktop bridge was contacted.",
      kind: "desktop-bridge",
      observedFact: { authenticated: false, kind: "bridge" },
      routeTarget: { kind: "local-bridge" },
      scope: "Fictional demo mode",
    ...
    },
    {
      ...
      interpretation:
        "Demo mode cannot perform a scoped proxy check and does not fabricate desktop success.",
      kind: "proxy-reachability",
      observedFact: { kind: "unavailable", reason: "Demo mode has no Controller" },
      routeTarget: { kind: "fixed-endpoint", route: "direct" },
      scope: "Fictional demo mode",
