...
const zh: Translation = {
  ...
  profiles: {
    ...
    detachConfirmationTitle: "解除这份订阅的关联？",
    detachConfirmationDescription: "Mish 会保留本地 YAML 文件，并停止 {source} 的自动更新。",
    detachingSubscription: "正在解除…",
    ...
    groups: "策略组",
    httpsDescription: "完整地址只在导入步骤中使用；已保存的配置只显示脱敏后的来源摘要。",
    httpsLabel: "订阅链接",
