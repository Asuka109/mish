...
const zh: Translation = {
  ...
  settingsPage: {
    ...
    backupFlow: {
      ...
      result: {
        busy: "另一项配置或设置更改仍在完成，请稍后重试恢复。",
        cancelled: "已取消，没有更改任何数据。",
        exported: "备份已保存到本地。",
        failed: "备份操作未完成，尚未确认任何成功更改。",
        idle: "",
        previewExpired: "验证后本地数据发生了变化，请重新选择备份文件。",
        recoveryRequired: "恢复清理需要重新启动，Mish 会在启动前处理保留的恢复记录。",
        restored: "备份已恢复。",
      },
      save: "选择位置并保存",
      schedules: "配置自动刷新设置",
  ...
  services: {
    ...
    restoreDefaultsDescription: "这会把当前服务监控替换为 Mish 默认值。取消即可保留当前草稿。",
    restoreDefaultsTitle: "恢复默认服务监控？",
