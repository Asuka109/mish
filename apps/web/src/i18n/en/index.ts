...
const en = {
  ...
  mobileSettings: {
    ...
    applicationSummary: "Appearance and language",
    appearanceDescription: "Choose a system-following, light, or dark appearance.",
    available: "Available",
    comingLater: "Coming later",
    configuration: "Core configuration",
    configurationDescription: "Only the bounded Mobile Core configuration state is shown.",
    core: "Embedded Core",
    coreDescription: "Version information comes from the packaged native Core authority.",
    currentState: "Current state",
    desktopControls: "Desktop controls",
    desktopControlsDescription:
      "Android does not expose System Proxy, Helper, loopback, or desktop-window controls.",
    diagnostics: "Diagnostics",
    diagnosticsDescription: "Review bounded Core, configuration, and lifecycle evidence.",
    dns: "VPN DNS policy",
    dnsDescription:
      "Shown only from Android's observed VPN facts; no resolver addresses are exposed.",
    failure: "Last lifecycle result",
    failureDescription: "Failures remain redacted and require an explicit recovery path.",
    failurePresent: "Action required",
    foreground: "Foreground service",
    foregroundDescription:
      "Android reports whether Mish currently owns the VPN foreground service.",
    languageDescription: "Changes Mish interface text only; user-provided names remain unchanged.",
    manageOnHome: "Manage on Home",
    network: "Network and DNS",
    networkDescription:
      "These are Android VPN observations, not editable desktop network settings.",
    networkSummary: "Observed VPN route and DNS state",
    noVerifiedCore: "No verified Core",
    none: "None",
    ...
    privacySummary: "Android privacy boundaries",
    publicRequest: "Public request",
    publicRequestDescription: "Running requires Android to observe one bounded public request.",
    recovery: "Recovery",
    recoveryAction: "Required action",
    recoveryActionDescription:
      "When recovery is required, cleanup remains an explicit Home action.",
    recoveryDescription: "Use the existing VPN lifecycle authority to recover safely.",
    recoveryStateDescription: "The displayed state is the current native lifecycle projection.",
    rootDescription: "Choose a focused Android setting. Unsupported desktop controls are omitted.",
    routes: "VPN routes",
    routesDescription: "Android reports whether Mish-owned VPN routes are applied.",
    settingFailed: "The setting was not confirmed. The last confirmed value remains in use.",
    settingPending: "Waiting for Mish to confirm this setting…",
    title: "Android settings",
    underlyingNetwork: "Underlying network",
    underlyingNetworkDescription:
      "Android reports whether a validated non-VPN network is available.",
    updates: "Updates",
    updatesAvailability: "Update availability",
    updatesAvailabilityDescription:
    ...
    vpn: "VPN",
    vpnDescription: "VPN state and permission come from the existing Android VpnService authority.",
    vpnPermission: "VPN permission",
    vpnPermissionDescription:
  ...
  mobileHome: {
    ...
    failedDescription: "Android could not complete VPN activation or cleanup safely.",
    failedState: "VPN activation failed",
    fixtureDescription:
    ...
    fixtureLabel: "Bounded configuration",
    ...
    recoveryDescription: "Mish-owned VPN resources must be cleaned before another activation.",
    recoveryState: "Recovery required",
    rejectReplacementAction: "Inject Failed Replace",
    replaceConfigAction: "Replace with Fixture B",
    retryAction: "Retry VPN Activation",
    ...
    startingDescription: "Android is establishing the TUN and starting the embedded Mobile Core.",
    startingState: "Starting VPN",
    stoppedDescription: "Android reports no active VPN session.",
    stoppedState: "VPN off",
    stoppingDescription: "Android is stopping Core and releasing Mish-owned VPN resources.",
    stoppingState: "Stopping VPN",
    ...
    unavailableState: "Waiting for network",
    unavailableValue: "Unavailable",
  },
  mobileFixture: {
    coreReady: "Mihomo {version:string} is packaged for the Android VPN runtime.",
    commandFailed: "The Android VPN command failed. Retry after reopening the app.",
    label: "Android VPN",
    lifecycleAction: "Start VPN",
    notificationAction: "Allow Status Notification",
    permissionAction: "Review VPN Permission",
    reconcileAction: "Clean Up VPN",
    stopAction: "Stop VPN",
    unavailable: "Android VPN and embedded Core are unavailable on this platform.",
  },
  toolbar: {
