...
const en = {
  ...
  services: {
    ...
    fixtureMetadataDescription: "Demo metadata only. No request will be sent.",
    fixtureUrlDescription: "Only HTTP and HTTPS metadata is accepted in demo mode.",
    labelError: "Enter a title.",
    manage: "Manage",
    interval15Minutes: "Every 15 minutes",
    interval1Minute: "Every minute",
    interval30Seconds: "Every 30 seconds",
    interval5Minutes: "Every 5 minutes",
