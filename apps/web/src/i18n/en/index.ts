...
const en = {
  ...
  capture: {
    ...
    helpAria: "Learn the difference between System Proxy and Enhanced Mode",
    ...
    title: "System Proxy and Enhanced Mode",
    tun: "Enhanced Mode (TUN)",
    tunDescription:
  ...
  destination: {
    ...
    routes: {
      ...
      itemTwoLabel: "Search",
      prerequisite: "Waiting for typed policy-group DTOs from the Part 2 local agent.",
      title: "Routes",
    },
    profiles: {
      description:
