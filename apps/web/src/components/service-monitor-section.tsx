...
const serviceStyles = tv({
  slots: {
    ...
    list: "service-monitor-list gap-0 bg-(--color-canvas) [&>:not(:nth-child(3n))]:border-r [&>:not(:nth-child(3n))]:border-(--color-hairline-soft) [&>:nth-child(n+4)]:border-t [&>:nth-child(n+4)]:border-(--color-hairline-soft) [&>.service-monitor-row:first-child]:rounded-ss-[7px] [&>.service-monitor-row:nth-child(3)]:rounded-se-[7px] [&>.service-monitor-row:nth-child(3n+1):nth-last-child(-n+3)]:rounded-es-[7px] [&>.service-monitor-row:last-child:nth-child(3n)]:rounded-ee-[7px] max-[900px]:[--section-grid-columns:1] max-[900px]:[&>*]:border-r-0 max-[900px]:[&>*]:rounded-none max-[900px]:[&>.service-monitor-row:first-child]:rounded-ss-[7px] max-[900px]:[&>.service-monitor-row:first-child]:rounded-se-[7px] max-[900px]:[&>.service-monitor-row:last-child]:rounded-es-[7px] max-[900px]:[&>.service-monitor-row:last-child]:rounded-ee-[7px] max-[900px]:[&>:not(:first-child)]:border-t max-[900px]:[&>:not(:first-child)]:border-(--color-hairline-soft) [html[data-runtime=mobile]_&]:[--section-grid-columns:1] [html[data-runtime=mobile]_&]:[&>*]:border-r-0 [html[data-runtime=mobile]_&]:[&>*]:rounded-none [html[data-runtime=mobile]_&]:[&>.service-monitor-row:first-child]:rounded-ss-[7px] [html[data-runtime=mobile]_&]:[&>.service-monitor-row:first-child]:rounded-se-[7px] [html[data-runtime=mobile]_&]:[&>.service-monitor-row:last-child]:rounded-es-[7px] [html[data-runtime=mobile]_&]:[&>.service-monitor-row:last-child]:rounded-ee-[7px] [html[data-runtime=mobile]_&]:[&>:not(:first-child)]:border-t [html[data-runtime=mobile]_&]:[&>:not(:first-child)]:border-(--color-hairline-soft)",
    row: "service-monitor-row grid min-h-[52px] min-w-0 grid-cols-[minmax(0,1fr)_minmax(74px,144px)_76px_minmax(0,1fr)] items-center gap-[10px] overflow-clip rounded-none border-0 bg-transparent py-0 pr-[13px] pl-[11px] text-left text-(--color-body) hover:bg-(--color-accent) hover:text-(--color-ink)",
    identity:
    ...
    icon: "service-monitor-icon grid size-[22px] place-items-center text-(--color-text-muted) [html[data-theme=dark]_&_[data-monochrome=true]]:invert [&_img]:block [&_img]:size-[18px] [&_img]:object-contain [&_img]:opacity-75",
    latency:
