...
impl MobileVpnSnapshot {
    ...
    pub(crate) fn from_lifecycle(state: &LifecycleState) -> Self {
        ...
        Self {
            ...
            core_availability: state.facts.core_availability.wire_name().into(),
            ...
            core_config_state: state.facts.core_config_state.wire_name().into(),
            ...
            notification_permission: state.facts.notification_permission.wire_name().into(),
            operation: state.latest_operation(),
            permission: state.facts.vpn_permission.wire_name().into(),
