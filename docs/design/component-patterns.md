...
Recovery actions belong in the registry presentation and are rendered from the
same descriptors in both the toast and notification-center item. System Proxy drift
