...
| Guided diagnostics                              | Process-global run history plus command                                            | `DiagnosticCoordinator`; Events provider/page                                                                                                | process memory, eight runs; active run ends on terminal status                                                                         | run ID, single active token, runtime identity, typed terminal status, Web operation ID                                                          | cancellation token and drop finalizer invalidate abandoned tasks; exact-operation Web cleanup                       | Rust lifecycle remains authoritative; Web feedback cannot be cleared or overwritten by a retired command completion                                 |
