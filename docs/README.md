...
| Android/mobile              | [`architecture/mobile-runtime-integration.md`](architecture/mobile-runtime-integration.md)             | [`architecture/mobile-native-shell-entry.md`](architecture/mobile-native-shell-entry.md), [`architecture/mobile-core-abi.md`](architecture/mobile-core-abi.md), [`operations/android-phase0-prototype.md`](operations/android-phase0-prototype.md), [`quality/mobile-validation.md`](quality/mobile-validation.md) |
...
- [`mobile-runtime-integration.md`](architecture/mobile-runtime-integration.md),
  [`mobile-native-shell-entry.md`](architecture/mobile-native-shell-entry.md),
  and [`mobile-core-abi.md`](architecture/mobile-core-abi.md) — mobile platform
  ownership, production-disabled outer-shell entry, native Core ABI, artifact
