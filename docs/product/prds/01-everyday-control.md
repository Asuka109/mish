...
| CTRL-F-007  | P0       | Status shall display the active profile as a quiet, switchable context.                                             | Given multiple valid profiles, when another profile is selected, then validation/activation progress appears and all profile-scoped Status data reconciles atomically.                                                                                                                                                              |
