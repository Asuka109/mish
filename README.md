...
provides the matching TypeScript mock server for integration tests. Neither
server is started by the default Web app. Static bundle hosting, Mihomo
controller-data reconciliation, Tauri, System Proxy, TUN, privileged helpers,
and native integrations remain unimplemented.
