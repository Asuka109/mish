...
window lifecycle preferences, and Apple Silicon ad-hoc test packaging. TUN and
its privileged helper remain truthfully unavailable. Developer ID signing and
notarization remain credential-gated release work.
