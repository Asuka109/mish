...
reconciliation through a narrow platform adapter, Controller-backed Status, a
native status-bar menu, native Sidebar material, window lifecycle preferences,
and Apple Silicon ad-hoc test packaging. TUN and privileged helpers remain
