...
includesAll(
  ...
  [
    ...
    "That run is external zero-step billing evidence, not a product failure",
    "no self-hosted success is claimed until its hands-on checklist has real run evidence",
