...
reserved to repair only that graph. Both host tasks were dispatched from ledger baseline
...
| P0c React Native host-toolchain dependency repair | active; `/root/p0c_rn_host_deps`; `/Users/asuka/.codex/worktrees/wave3b-p0c/mihomo-web-client`; baseline `4b126505` | `poc/rn/package.json`, `poc/pnpm-lock.yaml` | P0, P2, P3 | Add only exact RN 0.87 official-template/tool consumers: Babel core/runtime `7.29.7`, Community CLI and Android CLI `20.2.0`, RN Babel/Codegen/Gradle/Metro `0.87.0`, and Metro Babel transformer `0.87.0`; prove frozen install and all POC typechecks without iOS/Jest/template extras or install-script relaxation |
...
| P5 React Native admission | dependency-blocked after draft PR #544 / `47670a73`; `/root/p5_rn_admission`; `/Users/asuka/.codex/worktrees/wave3b-p5/mihomo-web-client`; TS, 11 tests, static deny, transcript replay, and Kotlin/Gradle native compile passed; awaiting P0c before bundle/APK/emulator claims | `poc/rn/**` excluding manifests | P0, P2, P3, P0c | RN New Architecture/Hermes resolves oRPC ESM, Query/XState/Mish Store, WebSocket/AbortSignal/AsyncIterable, and Kotlin TurboModule; proves the Store adapter in the RN renderer; dual-ABI debug APK installs/launches in a root-free emulator fixture without VPN/Core/network effects |
