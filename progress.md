...
| P0c React Native host-toolchain dependency repair | dispatching; task/worktree pending; baseline `6fdb60cd` | `poc/rn/package.json`, `poc/pnpm-lock.yaml` | P0, P2, P3 | Add only exact RN 0.87 official-template/tool consumers: Babel core/runtime `7.29.7`, Community CLI and Android CLI `20.2.0`, RN Babel/Codegen/Gradle/Metro `0.87.0`, and Metro Babel transformer `0.87.0`; prove frozen install and all POC typechecks without iOS/Jest/template extras or install-script relaxation |
