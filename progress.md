...
| P0d Electron bundler dependency repair | dispatching; task/worktree pending; baseline `0c2f8d67` | `poc/electron/package.json`, `poc/pnpm-lock.yaml` | P0, P0b | Add exact direct `vite@8.2.1` for the P4 bundler API already consumed by the DMG fixture, refresh only the isolated lock, and prove frozen install plus all POC typechecks without transitive Vitest resolution or install-script relaxation |
