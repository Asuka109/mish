...
| CUT-04 Electron host | active on `/root/cut04_electron_host`; worktree `/Users/asuka/.codex/worktrees/wave3c-cut04/mihomo-web-client`; branch `codex/cut04-electron-host`; cumulative source/ledger sync `codex/typescript-cutover@650f05f9`, implementation source `87792557`; `gpt-5.6-luna/max`, Chinese, confirmation-only | CUT-01, CUT-02, and CUT-03 integrated | Exclusive scope is `apps/desktop/**` excluding `src-tauri/**`, host tests/fixture metadata, and exact cumulative root lock updates. Deliver Electron 43.4.0 hardened main/preload/renderer with official oRPC MessagePort, fresh session authority, sandbox/context isolation, minimal preload API, bounded shutdown/transcripts and deterministic fixture replay. Keep credential-free isolated mounted-fixture acceptance separate; no POC production import, second RPC protocol, Tauri/Rust compatibility layer, credentials, release/signing/notarization, external network, VPN/TUN/Core, privileged settings, direct `dev` merge, or residual process/mount |
