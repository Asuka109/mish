...
export const BRIDGE_PROTOCOL_VERSION = 39 as const;
export const BRIDGE_MINIMUM_CLIENT_PROTOCOL_VERSION = 39 as const;
export const BRIDGE_MINIMUM_BACKEND_PROTOCOL_VERSION = 39 as const;
